  ...
  return (
    <section id="about" className="container mx-auto px-4 py-20 border-t">
      <motion.h2 
        ...
        className="text-3xl font-bold tracking-tight mb-8 bg-gradient-to-r from-amber-300 via-orange-400 to-orange-500 bg-clip-text text-transparent w-fit mx-auto"
      >
        About Me
      </motion.h2>            
      <motion.div
        ...
        className="mx-auto max-w-[75ch] space-y-5 text-muted-foreground leading-relaxed"
      >
        <p>
        ...
        <p>
          On top of that, I always have fun playing around with full stack and web dev
